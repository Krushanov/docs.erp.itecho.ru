...
**Метод:** POST  
**URL:** `https://beta.back.erp.itecho.ru/api/orders/{id}/nomenclatures`  
**Авторизация:** Bearer token
...
**Метод:** PUT  
**URL:** `https://beta.back.erp.itecho.ru/api/orders/{id}/nomenclatures/{id}`  
**Авторизация:** Bearer token
...
`https://beta.back.erp.itecho.ru/api/orders/16/nomenclatures/{id}`

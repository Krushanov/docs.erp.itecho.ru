...
#### Получение списка праздничных дней и часов работы выбранного магазина
...
#### Добавление праздничных дней и часов работы выбранного магазина
...
#### Обновление праздничных дней и часов работы выбранного магазина

**Метод:** PUT  
**URL:** `https://beta.back.erp.itecho.ru/api/shops/{id}/holidays/{id}`  
**Авторизация:** Bearer token
...
`https://beta.back.erp.itecho.ru/api/shops/17/holidays/1`
```JSON
{
	"holiday_date": "2025-05-09",
	"work_start_time": "09:00",
...
#### Удаление выбранных праздничных дней и часов работы магазина
...
```json
{
	"message": "Shop holiday deleted successfully."
}
```
...
`https://beta.back.erp.itecho.ru/api/shops/17/exceptions/{id}`
```JSON
{
	"exception_start_date": "2024-08-10",
	"exception_end_date": "2024-08-13"
}
```

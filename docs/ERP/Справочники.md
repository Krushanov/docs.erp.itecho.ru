...
`https://beta.back.erp.itecho.ru/api/brands/16`
...
```json
{
	"brand": {
		"id": 23,
		"name": "TEST",
		"avatar": "http:\/\/localhost:8000\/\/storage\/uploads\/yjohncMkjTSnvJ7FH4vksOtDYUy9pO2HDwmNU5Hc.svg",
		"created_at": "2024-11-20T08:44:33.000000Z"
	}
}
```
...
`https://beta.back.erp.itecho.ru/api/brands/23`
```json
{
	"name": "TEST",
	"avatar_id": 1,
...
`https://beta.back.erp.itecho.ru/api/page_types`

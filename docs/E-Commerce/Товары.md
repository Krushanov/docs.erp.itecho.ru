...
**Метод:** GET  
**URL:** `https://beta.back.erp.itecho.ru/api/counterparty/products/favourites`  
**Авторизация:** Bearer token  
**Параметры запроса:** отсутствуют  

##### Пример запроса

`https://beta.back.erp.itecho.ru/api/counterparty/products/favourites`
...
```json
{
  "products": {
    ...
    "first_page_url": "https://beta.back.erp.itecho.ru/api/counterparty/products/favourites?page=1",
    "from": 1,
    "last_page": 1,
    "last_page_url": "https://beta.back.erp.itecho.ru/api/counterparty/products/favourites?page=1",
    "links": [
      {
        "url": null,
        "label": "&laquo; Предыдущая",
      ...
      {
        "url": "https://beta.back.erp.itecho.ru/api/counterparty/products/favourites?page=1",
        "label": "1",
        "active": true
      },
      {
    ...
    "next_page_url": null,
    "path": "https://beta.back.erp.itecho.ru/api/counterparty/products/favourites",
    "per_page": 10,
    "prev_page_url": null,
    "to": 1,
    "total": 1
...
**Метод:** DELETE  
**URL:** `https://beta.back.erp.itecho.ru/api/counterparty/products/favourites/{id}`  
**Авторизация:** Bearer token  
**Параметры запроса:** отсутствуют  

##### Пример запроса

`https://beta.back.erp.itecho.ru/api/counterparty/products/favourites/1`
